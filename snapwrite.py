...
Updated to work in Python 3.8.
Due to the changes made, it probably doesn't work with Python 2.x anymore.
...
def write_snapshot(n_part, folder=None, from_text=True, data_list=None, outfile='init.dat'):
    N_gas = n_part[0]
